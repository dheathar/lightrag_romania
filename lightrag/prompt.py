...
2. Content & Grounding:
  ...
  - The Knowledge Graph entities provide high-level summaries - use these to understand the topic structure.
  - The relationships between entities provide connections - use these to understand how concepts relate.
  - **CRITICAL: Document Chunks contain the actual source text with SPECIFIC DETAILS - always check chunks for precise information like lists, numbers, names, and specific facts.**
  - When answering questions about specific items (like priorities, objectives, features), the answer is almost always in the Document Chunks.
  - Synthesize information from ALL sections. Do not conclude you lack information based solely on the Knowledge Graph section.
...
2. Content & Grounding:
  ...
  - Document Chunks provide source text with specific details - use these to build your answer.
  - IMPORTANT: If the Context contains relevant chunks, you SHOULD be able to answer. Synthesize the available information.
  - Only state you lack information if the Context is completely empty or entirely unrelated to the query.
