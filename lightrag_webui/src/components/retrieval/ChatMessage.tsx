              ...
              {message.references.map((ref, idx) => {
                ...
                return (
                  <div
                    ...
                    className="group relative flex items-start gap-2 p-2 rounded-md bg-muted/30 hover:bg-muted/50 transition-colors text-xs"
                  >
                    {/* Reference number badge */}
                    <div className="flex-shrink-0 w-5 h-5 rounded-full bg-primary/10 text-primary flex items-center justify-center font-semibold text-[10px] mt-0.5">
                      {idx + 1}
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        {hasContent && (
                          <span className="text-[10px] text-muted-foreground bg-muted px-1.5 py-0.5 rounded">
                            {ref.content.length} chunk{ref.content.length > 1 ? 's' : ''}
                          </span>
                        )}
                        ...
                        {hasContent && (
                          <button
                            ...
                            title={isExpanded ? "Hide chunks" : "Show chunks"}
                          >
                            <svg
                      ...
                      {hasContent && isExpanded && (
                        <div className="mt-2 pt-2 border-t border-border/30 space-y-2">
                          {ref.content.map((chunk, chunkIdx) => (
                            <div key={chunkIdx} className="text-[11px] bg-muted/50 p-2 rounded border border-border/30">
